...
public class PizzaOrder
{
   public static void main (String [] args)
   {
      ...
      {
	  if ( inches == 10 )
	      cost = Double.parseDouble("10.99");
	  if ( inches == 12 )
	      cost = Double.parseDouble("12.99");
	  if ( inches == 14 )
	      cost = Double.parseDouble("14.99");
	  if ( inches == 16 )
	      cost = Double.parseDouble("16.99");
      }
      else 
      {
		  System.out.println("The size you chose was invalid so a 12 inch pizza will be made.");
	      inches = 12;
	      cost = Double.parseDouble("12.99");
      }
