...
/** 
   The BagListType class is a concrete class for storing a list 
   of objects in a bag structure.
*/

public class BagListType<E> implements BagList<E>
{
    ...
    */
    ...
    {
	// Check current capacity and resize the list if required.
	capacity();
    ...
    /** Remove one occurrence of specified element from the list.
	@param target The specified element.
	@return true if a successful deletion occurred; false
	        otherwise.
    */
	...
	// is found, remove it and stop searching.
	...
	// If the value was found, shift all subsequent elements
    ...
    /** Remove all occurrences of a specified element from the list.
	@param target The specified element to remove.
	@return The element removed from the list.
    */
    public E erase(E target)
    {
	// Use the erase_one method repeatedly to remove an instance  
	// of the element until there is none left. 
    ...
    /** Count the number of times a specified element occurs
	in the list.
	@param target The specified element to count.
	@return The number of times the element occurs in the
	        list.
    */
